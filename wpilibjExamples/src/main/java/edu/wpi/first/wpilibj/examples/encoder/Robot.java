...
public class Robot extends TimedRobot {
   ...
   * set this parameter to true, the direction of the encoder will be reversed, in case it makes
   * more sense mechanically. The final (optional) parameter specifies encoding rate (k1X, k2X, or
   * k4X) and defaults to k4X. Faster (k4X) encoding gives greater positional precision but more
   * noise in the rate.
   */
